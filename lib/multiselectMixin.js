...
function filterOptions(options, search, label) {
  return label ? options.filter(function (option) {
    return includes((0, _diacritics.remove)(option[label]), search);
  }) : options.filter(function (option) {
    return includes((0, _diacritics.remove)(option), search);
  });
}
...
module.exports = {
  ...
  computed: {
    filteredOptions: function filteredOptions() {
      ...
      var normalizedSearch = (0, _diacritics.remove)(search.toLowerCase());
